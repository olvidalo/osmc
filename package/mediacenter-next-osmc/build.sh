...
game.libretro.dinothawr game.libretro.dosbox game.libretro.fbalpha2012 game.libretro.fceumm \
game.libretro.dosbox game.libretro.fbalpha2012 game.libretro.fceumm game.libretro.fmsx game.libretro.fuse \
game.libretro.gambatte game.libretro.genplus game.libretro.gw game.libretro.handy game.libretro.hatari \
game.libretro.lutro game.libretro.meteor game.libretro.mgba game.libretro.mupen64plus game.libretro.nestopia \
