...
then
	...
	ADDONS_GAME="game.libretro.2048 game.libretro game.libretro.2048 game.libretro.4do game.libretro.beetle-bsnes game.libretro.beetle-gba \
...
# game.libretro.dosbox game.libretro.fbalpha2012 game.libretro.fceumm game.libretro.fmsx game.libretro.fuse game.libretro.gambatte game.libretro.genplus game.libretro.gw game.libretro.handy game.libretro.hatari game.libretro.lutro game.libretro.meteor game.libretro.mgba game.libretro.mupen64plus game.libretro.nestopia game.libretro.nx game.libretro.o2em game.libretro.pcem game.libretro.pcsx-rearmed game.libretro.picodrive game.libretro.pokemini game.libretro.prosystem game.libretro.quicknes game.libretro.reicast game.libretro.scummvm game.libretro.snes9x game.libretro.snes9x2002 game.libretro.snes9x2010 game.libretro.stella game.libretro.tgbdual game.libretro.tyrquake game.libretro.vba-next game.libretro.vbam game.libretro.vecx game.libretro.virtualjaguar game.libretro.yabause game.moonlight"
	...
	test "$1" == pc && echo "Depends: ${COMMON_DEPENDS}, amd64-libnfs-osmc, amd64-librtmp-osmc, amd64-libshairplay-osmc, amd64-libbluray-osmc, amd64-libsqlite-osmc, libxrandr2, xserver-xorg-core, xserver-xorg, xinit, xfonts-base, x11-xserver-utils, xauth, alsa-utils, amd64-libcrossguid-osmc, xserver-xorg-video-intel" >> files/DEBIAN/control
  	test "$1" == rbp1 && echo "Depends: ${COMMON_DEPENDS}, rbp1-libcec-osmc (>=3.1.0-2), armv6l-libnfs-osmc, armv6l-librtmp-osmc, armv6l-libshairplay-osmc, armv6l-libbluray-osmc, armv6l-libsqlite-osmc, rbp-userland-osmc, armv6l-splash-osmc, armv6l-libcrossguid-osmc" >> files/DEBIAN/control
