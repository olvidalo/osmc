...
set (p8-platform_INCLUDE_DIRS /usr/osmc/include/p8-platform /usr/osmc/include)
...
if(WIN32)
  set (p8-platform_LIBRARY "/usr/osmc//usr/osmc/lib/p8-platform.lib")
else(WIN32)
  set (p8-platform_LIBRARY "-L/usr/osmc//usr/osmc/lib -lp8-platform")
endif(WIN32)
